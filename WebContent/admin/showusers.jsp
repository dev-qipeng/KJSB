											...
											<div id=middlebody>
												...
												<table class="mars" cellspacing="1" cellpadding="0"
													...
													<tbody>
														...
														<s:iterator value="#session.expertList" var="e">
															<tr bgcolor="#e4f1fe">
																<td bgcolor="#f3f3f3"><div align="center">
																		<s:property value="#e.name" />
																	</div></td>
																<td bgcolor="#f3f3f3"><div align="center">专家</div></td>
																<td bgcolor="#f3f3f3"><div align="center">
																		<a
																			href="admin_deleteExpert.action?expertid=<s:property value="#e.expertid"/>">删除</a>
																	</div></td>
															</tr>
														</s:iterator>
														<s:iterator value="#session.unitList" var="u">
															<tr bgcolor="#e4f1fe">
																<td bgcolor="#f3f3f3"><div align="center">
																		<s:property value="#u.unitname" />
																	</div></td>
																<td bgcolor="#f3f3f3"><div align="center">单位</div></td>
																<td bgcolor="#f3f3f3"><div align="center">
																		<a
																			href="admin_deleteUnit.action?unitid=<s:property value="#u.unitid"/>">删除</a>
																	</div></td>
															</tr>
														</s:iterator>
														<tr bgcolor="#e4f1fe">
															<td bgcolor="#f3f3f3" colspan="3"><div
																	align="center">
																	<a href="admin_addUser.action">添加用户</a>
																</div></td>
														</tr>
													</tbody>
												</table>
