											...
											<div id=middlebody>
												...
												<table class="mars" cellspacing="1" cellpadding="0"
													...
													<tbody>
														...
														<s:iterator value="#session.expertList" var="el">
														<tr bgcolor="#e4f1fe">
															<td bgcolor="#f3f3f3"><div align="center"><s:property value="#el.expertid"/></div></td>
															<td bgcolor="#f3f3f3"><div align="center"><s:property value="#el.name"/></div></td>
															<td bgcolor="#f3f3f3"><div align="center"><s:property value="#el.unitname"/></div></td>
															<td bgcolor="#f3f3f3"><div align="center"><s:property value="#el.title"/></div></td>
															<td bgcolor="#f3f3f3"><div align="center"><s:property value="#el.sex"/></div></td>
															<td bgcolor="#f3f3f3"><div align="center"><s:property value="#el.tel"/></div></td>
															<td bgcolor="#f3f3f3"><div align="center"><s:property value="#el.introduction"/></div></td>
															<td bgcolor="#f3f3f3"><div align="center">
																	<a href="admin/expert_updateExpert?expertid=<s:property value="#el.expertid"/>">修改</a>
																</div></td>
															<td bgcolor="#f3f3f3"><div align="center">
																	<a href="admin/expert_deleteExpert?expertid=<s:property value="#el.expertid"/>">删除</a>
																</div></td>
														</tr>
														</s:iterator>
													</tbody>
