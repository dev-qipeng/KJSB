													...
													<tbody>
														<tr>
															<td width="44%" bgcolor="#f3f3f3"><div align="right">
																	<img src="${pageContext.request.contextPath }/images/tabl.gif" width="298" height="211" />
																</div></td>
															<td width="56%" align="left" valign="top"
																bgcolor="#f3f3f3"><table width="90%" border="0"
																		...
																		<td><table width="100%" border="0"
																				...
																				<tr>
																					...
																					<td><p align="center">管理员功能介绍</p>
																						1:登录用户管理,专家用户和单位用户增加和销毁；<br> 2:专家信息管理,专家用户的修改和删除；<br>
																						3:单位信息管理，单位信息的修改和删除；<br>
																						4:项目管理,项目类别的添加、修改和删除以及项目的浏览和删除。<br></td>
																				</tr>
																			</table></td>
																		<td>&nbsp;</td>
																	</tr>
