											...
											<div id=middlebody>
												<table cellspacing="0" cellpadding="0" width="100%"
													...
													<tbody>
														<tr>
															<td><div align="left">
																	|&nbsp;&nbsp;欢迎,单位用户:<s:property value="unitname"/>&nbsp;&nbsp;|&nbsp;&nbsp;<a
																		class="table_t"
															...
															<td><div align="center">
																	<a
																		href="unit_unitinfo.action">单位信息</a>
																</div></td>
															<td><div align="center">
																	<a
													...
													<tbody>
														<tr>
															<td width="44%" bgcolor="#f3f3f3"><div align="right">
																	<img
																		src="${pageContext.request.contextPath }/images/cloc.gif"
																		width="298" height="211" />
																</div></td>
															<td align="left" valign="top" bgcolor="#f3f3f3"><table
																		...
																		<td><table width="100%" border="0"
																				...
																				<tr>
																					...
																					<td><p align="center">单位功能介绍</p>
																						<p align="left">
																							1:单位用户信息的修改；<br> <br> 2:单位用户密码的修改；<br> <br> 3:项目申报；<br> <br>
																							4:查询申报项目并修改没有审批的项目;<br> <br>
																						</p>
																						<p align="center">
																							<br />
																						</p></td>
